// ======================================================================
// \title  AltamiraDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <AltamiraDeployment/Top/AltamiraDeploymentTopologyAc.hpp>
#include <AltamiraDeployment/Top/AltamiraDeploymentPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(AltamiraDeploymentPacketsPkts, AltamiraDeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name AltamiraDeployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        AltamiraDeployment::blockDrv.callIsr();
