// ======================================================================
// \title  AltamiraDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef ALTAMIRADEPLOYMENT_ALTAMIRADEPLOYMENTTOPOLOGY_HPP
#define ALTAMIRADEPLOYMENT_ALTAMIRADEPLOYMENTTOPOLOGY_HPP
// Included for access to AltamiraDeployment::TopologyState and AltamiraDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <AltamiraDeployment/Top/AltamiraDeploymentTopologyDefs.hpp>

// Remove unnecessary AltamiraDeployment:: qualifications
using namespace AltamiraDeployment;
namespace AltamiraDeployment {
/**
 ...
 * AltamiraDeployment::TopologyState see: AltamiraDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type AltamiraDeployment::TopologyState see: AltamiraDeploymentTopologyDefs.hpp.
 *
