...
#include <AltamiraDeployment/Top/AltamiraDeploymentTopology.hpp>
...
static void signalHandler(int signum) {
    AltamiraDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    AltamiraDeployment::TopologyState inputs;
    ...
    AltamiraDeployment::setupTopology(inputs);
    AltamiraDeployment::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    AltamiraDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
